...
private const val DESTRUCTIVE_LIGHT = 0xFFE7000BL
private const val DESTRUCTIVE_DARK = 0xFFFF6467L
...
private fun baseLight(
    ...
    primaryPressed = Color(primary),
    primaryDisabled = Color(primary),
    onPrimary = Color(onPrimary),
    secondary = Color(secondary),
    secondaryHover = Color(secondary),
    onSecondary = Color(onSecondary),
    destructive = Color(DESTRUCTIVE_LIGHT),
    destructiveHover = Color(DESTRUCTIVE_LIGHT),
...
private fun baseDark(
    ...
    destructiveHover = Color(DESTRUCTIVE_DARK),
    onDestructive = Color(0xFFFFFFFF),
    background = Color(background),
    surface = Color(background),
    surfaceVariant = Color(secondary),
    onSurface = Color(foreground),
    onSurfaceVariant = Color(onSurfaceVariant),
    // Real shadcn's dark border is a 10%-alpha white overlay on `background`, not an
    // opaque token; we approximate the composited result as a flat color instead.
