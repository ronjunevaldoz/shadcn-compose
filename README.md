...
[![Compose Multiplatform](https://img.shields.io/badge/Compose%20Multiplatform-1.12.1-blue.svg)](https://www.jetbrains.com/lp/compose-multiplatform/)
...
> [!NOTE]
> **Compatibility**: Requires **Compose Multiplatform 1.12.1+** and **Kotlin 2.4.0+**. Add `@file:OptIn(ExperimentalFoundationStyleApi::class)` to files referencing component styles.
